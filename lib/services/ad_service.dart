...
class AdService {
  ...
  /// chapters, the shape-mastery final challenge, and the new
  /// perimeter/area finale. Core teaching chapters (1,2,3,5,6,7,9,10,11,12)
  /// never interrupt with an ad.
  static const Set<int> _interstitialBreakpoints = {4, 8, 13, 15};
