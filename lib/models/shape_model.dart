...
class ShapeMeta {
  ...
  final List<String> realWorldImages; // asset paths, correct matches
  final List<String> distractorImages; // asset paths, wrong matches for "find it" activity
  final String iconAsset; // small flat thumbnail, used on the home screen chapter list
  ...
  const ShapeMeta({
    ...
    required this.realWorldImages,
    required this.distractorImages,
